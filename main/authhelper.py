...
client_id = deviare_settings.deviare_config['CLIENT_ID']
client_secret = deviare_settings.deviare_config['CLIENT_SECRET']

# Constant strings for OAuth2 flow
# The OAuth authority
authority = deviare_settings.deviare_config['MS_AUTHORITY']
